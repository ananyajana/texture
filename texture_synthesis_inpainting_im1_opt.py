...
IMAGE_DIM_HEIGHT = 240
IMAGE_DIM_WIDTH = 320
TOP_PATCH_HEIGHT = LEFT_PATCH_WIDTH = 19
BOTTOM_PATCH_HEIGHT = 29
RIGHT_PATCH_WIDTH = 22
MAX_PIXEL_VALUE = 255
SEED_SIZE = 3
WINDOW_SIZE = 11
GAUSS_SIGMA = 1.7
...
#print("reading image")
sample_image1 = imread("test_im1.bmp")
sample_image = np.zeros(((IMAGE_DIM_HEIGHT - (TOP_PATCH_HEIGHT + BOTTOM_PATCH_HEIGHT)), (IMAGE_DIM_WIDTH - (LEFT_PATCH_WIDTH + RIGHT_PATCH_WIDTH))))
sample_image = sample_image1[TOP_PATCH_HEIGHT: IMAGE_DIM_HEIGHT - BOTTOM_PATCH_HEIGHT, \
      LEFT_PATCH_WIDTH: IMAGE_DIM_WIDTH - RIGHT_PATCH_WIDTH] \
...
sample_image2 = sample_image3 = np.zeros((35, sample_image_col))
sample_image4 = sample_image5 = np.zeros((sample_image_row, 35))
sample_image2 = sample_image[0:35, 0:sample_image_col]
sample_image3 = sample_image[sample_image_row - 35:sample_image_row, 0:sample_image_col]
sample_image4 = sample_image[0:sample_image_row, 0:35]
sample_image5 = sample_image[0:sample_image_row, sample_image_col - 35:sample_image_col]


#print("normalizing image by dividing with max pixel value")
sample_image_normalized = sample_image/MAX_PIXEL_VALUE
sample_image_normalized1 = sample_image1/MAX_PIXEL_VALUE
sample_image_normalized2 = sample_image2/MAX_PIXEL_VALUE
sample_image_normalized3 = sample_image3/MAX_PIXEL_VALUE
sample_image_normalized4 = sample_image4/MAX_PIXEL_VALUE
sample_image_normalized5 = sample_image5/MAX_PIXEL_VALUE
...
#plt.gcf().clear()
#print(img1.format)
total_pixels = (TOP_PATCH_HEIGHT * IMAGE_DIM_WIDTH) + \
(BOTTOM_PATCH_HEIGHT * IMAGE_DIM_WIDTH) + \
(LEFT_PATCH_WIDTH * (IMAGE_DIM_HEIGHT - (TOP_PATCH_HEIGHT + BOTTOM_PATCH_HEIGHT))) + \
(RIGHT_PATCH_WIDTH * (IMAGE_DIM_HEIGHT - (TOP_PATCH_HEIGHT + BOTTOM_PATCH_HEIGHT)))  
...
filled_list[TOP_PATCH_HEIGHT: IMAGE_DIM_HEIGHT - BOTTOM_PATCH_HEIGHT, \
      LEFT_PATCH_WIDTH: IMAGE_DIM_WIDTH - RIGHT_PATCH_WIDTH] \
      = np.ones(((IMAGE_DIM_HEIGHT - BOTTOM_PATCH_HEIGHT - TOP_PATCH_HEIGHT), \
                 (IMAGE_DIM_WIDTH - RIGHT_PATCH_WIDTH - LEFT_PATCH_WIDTH)))
...
#print("hello")
possible_frames2, possible_frames_centers2 =  extract_all_frames_centers(sample_image_normalized2)
possible_frames3, possible_frames_centers3 =  extract_all_frames_centers(sample_image_normalized3)
possible_frames4, possible_frames_centers4 =  extract_all_frames_centers(sample_image_normalized4)
possible_frames5, possible_frames_centers5 =  extract_all_frames_centers(sample_image_normalized5)

possible_frames = np.concatenate((possible_frames2, possible_frames3, possible_frames4, possible_frames5), axis = 0)
possible_frames_centers = np.concatenate((possible_frames_centers2, possible_frames_centers3, possible_frames_centers4, possible_frames_centers5), axis = 0)
...
io.imsave("test_im1_synthesized.jpeg", image)
