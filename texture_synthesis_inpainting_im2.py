...
MID_PATCH_WIDTH = 41
MAX_PIXEL_VALUE = 255
UPPER_PATCH_LINE = 148
LOWER_PATCH_LINE = 190
SEED_SIZE = 3
WINDOW_SIZE = 19
GAUSS_SIGMA = 3.3
ERR_THRESHOLD = 0.3
...
#print("reading image")
sample_image = imread("test_im2.bmp")
...
sample_image1 = np.zeros(((UPPER_PATCH_LINE + 1), IMAGE_DIM_WIDTH))
sample_image2 =  np.zeros(((IMAGE_DIM_HEIGHT - UPPER_PATCH_LINE), IMAGE_DIM_WIDTH))
...
#sample_image1 = sample_image[0:(UPPER_PATCH_LINE+1), 0:IMAGE_DIM_WIDTH]
#sample_image2 = sample_image[LOWER_PATCH_LINE:IMAGE_DIM_HEIGHT, 0:IMAGE_DIM_WIDTH]
sample_image1 = sample_image[110:(UPPER_PATCH_LINE+1), 0:IMAGE_DIM_WIDTH]
sample_image2 = sample_image[LOWER_PATCH_LINE:IMAGE_DIM_HEIGHT - 90, 0:IMAGE_DIM_WIDTH]
...
total_pixels = MID_PATCH_WIDTH * IMAGE_DIM_WIDTH
...
filled_list[0: (UPPER_PATCH_LINE + 1), 0: IMAGE_DIM_WIDTH] \
      = np.ones(((UPPER_PATCH_LINE + 1), IMAGE_DIM_WIDTH))
      
filled_list[LOWER_PATCH_LINE: IMAGE_DIM_HEIGHT, 0: IMAGE_DIM_WIDTH] \
      = np.ones(((IMAGE_DIM_HEIGHT - LOWER_PATCH_LINE), IMAGE_DIM_WIDTH))
...
#print("hello")
possible_frames1, possible_frames_centers1 =  extract_all_frames_centers(sample_image_normalized1)
possible_frames2, possible_frames_centers2 =  extract_all_frames_centers(sample_image_normalized2)
possible_frames = np.concatenate((possible_frames1, possible_frames2), axis=0)
#possible_frames = np.asarray(possible_frames1) + np.asarray(possible_frames2)
possible_frames_centers = np.concatenate((possible_frames_centers1, possible_frames_centers2), axis = 0)
#possible_frames = possible_frames1.extend(possible_frames2)
#possible_frames_centers = possible_frames_centers1.extend(possible_frames_centers2)
